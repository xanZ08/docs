...
* [Fixed #730](https://github.com/NativeScript/nativescript-cli/issues/730): Executing `tns livesync android` throws stdout maxBuffer exceeded.
* [Fixed #772](https://github.com/NativeScript/nativescript-cli/issues/772): Executing `tns platform update ios` command does not update metadata generator.
...
* [Fixed #811](https://github.com/NativeScript/nativescript-cli/issues/811): Executing `tns livesync <Platform> --watch` reports an error when platform specific file is changed.
...
* [Fixed #896](https://github.com/NativeScript/nativescript-cli/issues/896): Executing `tns run <Platform>` after `tns livesync <Platform>` starts the last synced app on the device.
...
* [Fixed #806](https://github.com/NativeScript/nativescript-cli/issues/806): Executing the `tns library add android` command does not execute Android project update if target 17 is not installed.
* [Fixed #807](https://github.com/NativeScript/nativescript-cli/issues/807): Android native libs are not respected correctly if the plugin is added as a depedency of another plugin.
...
* [Fixed #776](https://github.com/NativeScript/nativescript-cli/issues/776): Executing `tns livesync ios --emulator --watch` doesn't sync changes.
* [Fixed #777](https://github.com/NativeScript/nativescript-cli/issues/777): Executing `tns library add ios` does not build correct relative paths to referenced frameworks for mdgenerator.
...
* [Fixed #652](https://github.com/NativeScript/nativescript-cli/issues/652): Executing `tns debug ios` does not load inspector from the added iOS runtime.
* [Fixed #663](https://github.com/NativeScript/nativescript-cli/issues/663): Verify that Java is at least 1.7.
* [Fixed #671](https://github.com/NativeScript/nativescript-cli/issues/671): Executing `tns debug ios` doesn't work for projects created with framework versions earlier than 1.2.0.
* [Fixed #679](https://github.com/NativeScript/nativescript-cli/issues/679): Executing `tns library add ios` adds the framework with its full path in the Xcode project.
...
* [Fixed #722](https://github.com/NativeScript/nativescript-cli/issues/722): Executing `tns debug` builds and installs the app twice.
* [Fixed #742](https://github.com/NativeScript/nativescript-cli/issues/742): Executing `tns livesync android` doesn't work on some Android devices.
...
* [Implemented #523](https://github.com/NativeScript/nativescript-cli/issues/523): Added the `$ tns livesync <Platform>` command. You can use it to quickly synchronize changes to connected devices without rebuilding and re-deploying your apps.
...
* [Fixed #599](https://github.com/NativeScript/nativescript-cli/issues/599): The NativeScript CLI always creates a `tmp` directory in the current directory when you run any command and modify the `package.json` file for the project.
* [Fixed #584](https://github.com/NativeScript/nativescript-cli/issues/584): The NativeScript CLI references the files in the project with their absolute paths instead of their relative paths. This might cause the project to stop working when transferred to another location and might cause issues with your application packages.
...
* [Fixed #555](https://github.com/NativeScript/nativescript-cli/issues/555): In some cases, the CLI incorrectly merges the plugin platform-specific `AndroidManifest.xml` or `Info.plist` with the respective platform-specific configuration files from the project.
...
* [Implemented #362](https://github.com/NativeScript/nativescript-cli/issues/362): You can use npm as a package manager for your NativeScript projects.
...
* [Implemented #447](https://github.com/NativeScript/nativescript-cli/issues/447): Use `tns run ios`, `tns run android` and `tns emulate android` to print the output of the running application in the console.
...
* [Fixed #446](https://github.com/NativeScript/nativescript-cli/issues/446): Executing `tns autocomplete disable` might not disable command-line completion properly.
...
* [Fixed #348](https://github.com/NativeScript/nativescript-cli/issues/348): Executing `tns platform add ios` downloads the latest experimental version of the iOS runtime instead of the latest stable version.
...
* [Fixed #312](https://github.com/NativeScript/nativescript-cli/issues/312): Executing `tns platform add ios` does not preserve your app ID, if not default.
